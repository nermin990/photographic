    ...
    <div class="container">
        <div class="row">
            <div id="contact" class="footer-holder">
                ...
                <div class="footer-holder-part col-md-2 offset-2">
                    <h4>Menu</h4>
                    <div class="footer-holder-part__menu">
                        <?php
                        wp_nav_menu(array(
                            'menu' => "main-menu",
                        ));
                ...
                <div class="footer-holder-part col-md-3 offset-1">
                    <h4>Contact Me</h4>
                    <div class="footer-holder-part__contact-me">
                        <a href="mailto:photographer@gmail.com">Email: photographer.com</a>
                        <a href="tel:+38165656565">Phone: +38165656565</a>
                        <div class="footer-holder-part__contact-me-icons">
